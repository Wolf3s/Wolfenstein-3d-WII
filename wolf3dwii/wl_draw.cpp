...
//
    ...
    US_Printf("Mouse-X: %d ----- Mouse-Y: %d", mousexmove, mouseymove);
	VWB_Bar(0,10,320,10,bordercol);
	PrintX=4; PrintY=10;
	US_Printf("User Movement:: controlx: %d ----- controly: %d", controlx, controly);
	VWB_Bar(0,20,320,10,bordercol);
	PrintX=4; PrintY=20;
	US_Printf("User Movement:: controlz: %d ----- joyz: %d", controlz, joyz);
	*/
