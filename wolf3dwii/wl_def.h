...
#endif
#include <SDL/SDL.h>
#include <SDL/SDL_GameCubeInterface.h>   // MrPeanut's controller manager
...
// current user input
//
extern  int         controlx,controly,controlz;              // range from -100 to 100
...
//mrp
extern  int         interfaceMode;     // the controller mode we are currently using
